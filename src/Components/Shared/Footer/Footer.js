                ...
                <div className="container py-5">
                    <div className="row pt-5">
                        ...
                        <div
                            ...
                            mb-5">
                            <p
                                className="fw-bold fs-5 White">
                                ABOUT US
                            </p>
                            <small>
                                Steadfast, the leader in crowdsourcing talent,
                                finds top candidates in half the time and for half the cost, through its extensive network
                                of recruiters and industry professionals.
                            </small>
                        </div>
                        {/* Contact information */}
                        <div className="col-6 col-md-3">
                            <p className="fw-bold fs-5 White">
                                CONTACT INFO
                            </p>
                            <small>
                                <FontAwesomeIcon icon={faHome} />
                                100 Franklin Square Dr, Suite 402.
                            </small>
                            <small>
                                Somerset, NJ 08873
                            </small>
            ...
            <section className="bg-black White">
                <p
                    className="
                        ...
                        py-4 
                        fs-6">
                    © 2021 COPYRIGHT STEADFAST, INT. SERVICES ALL RIGHTS RESERVED.
                </p>
            </section>
        </section>
    );
